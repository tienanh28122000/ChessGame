...
public class Board implements Serializable {
    ...
    /**
     *
     * @param piece The piece mà mình muốn biết position
     * @return trả về một mảng có giá trị [rowPos, colPos]
     */
    ...
    /**
     * Với method này, một piece có thể đc moved tới field khác
    ...
    /**
     * toString method tạo String of the board
     * @return nó returns lại full board
     */
    public String toString() {
        ...
        //First Line: Tất cả letters đc set với space giữa chúng
        for(char i: LETTERS) {
        ...
        //parting-line được đặt giữa letters và actual field
        for (char i : LETTERS) {
            endString.append("-----");
        }
        ...
        //The board được tạo với một số ở đầu mỗi dòng
        for(int i = 0; i < NUMS.length; i++) {
            ...
            //Parting-line giữa dòng này và dòng khác
            for(int j = 0; j < 8; j++){
                endString.append("-----");
            }
